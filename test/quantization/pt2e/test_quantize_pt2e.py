...
class PT2QuantizationTestCase(QuantizationTestCase):
    """
    ...
    def _test_quantizer(
        ...
        if check_against_fx_quant:
            ...
            node_occurrence = {}
            for k, v in PT2QuantizationTestCase._MAP_TO_FX_TRACED_OPS.items():
...
@skipIfNoQNNPACK
class TestQuantizePT2E(PT2QuantizationTestCase):
...
class TestQuantizePT2EModels(PT2QuantizationTestCase):
